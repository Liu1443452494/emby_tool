...
<style scoped>
.poster-manager-dialog :deep(.el-dialog__body) { padding: 0; height: 85vh; }
.view-container { height: 100%; display: flex; flex-direction: column; }
.search-view { padding: 20px 30px; box-sizing: border-box; height: calc(100% - 72px); }
.view-title { text-align: center; font-size: 20px; font-weight: 500; margin: 10px 0 30px 0; }
...
.dialog-footer { padding: 20px 30px; text-align: right; border-top: 1px solid var(--el-border-color-light); }
.manage-view { height: 100%; }
.manage-header { flex-shrink: 0; display: flex; justify-content: space-between; align-items: center; padding: 15px 30px; background-color: var(--el-fill-color-light); border-bottom: 1px solid var(--el-border-color); }
.comparison-area { flex-grow: 1; display: flex; overflow: hidden; }
.side-panel { flex: 1; padding: 20px; display: flex; flex-direction: column; }
.panel-header { text-align: center; font-size: 16px; font-weight: bold; margin-bottom: 20px; }
.main-divider { height: auto; margin: 20px 0; }
.image-layout { flex-grow: 1; display: flex; gap: 20px; }
.poster-section { width: calc(333 / (333 + 320) * 100%); display: flex; flex-direction: column; }
.right-section { width: calc(320 / (333 + 320) * 100%); display: flex; flex-direction: column; gap: 20px; }
.backdrop-section, .logo-section { flex: 1; display: flex; flex-direction: column; }
</style>