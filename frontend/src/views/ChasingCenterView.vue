  ...
  <div class="chasing-center-page">
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <el-button @click="isConfigDrawerVisible = true" :icon="Setting">设置</el-button>
      </div>
    </div>

    <div class="main-content">
      <div 
        class="list-container energy-ring-loading-container" 
    ...
    >
      <div class="drawer-content">
        <el-form v-if="!store.isLoading" :model="localConfig" label-position="top">
          ...
          <div class="action-buttons">
            <el-divider content-position="center">手动操作</el-divider>
      ...
      <template #footer>
        <div class="drawer-footer">
          <el-button @click="isConfigDrawerVisible = false">取消</el-button>
...
import { Notification, CircleCheck, Plus, Setting } from '@element-plus/icons-vue';
...
const isConfigDrawerVisible = ref(false); // 控制抽屉显示
...
.header-content p { margin: 0; color: var(--el-text-color-secondary); }
