...
export const useConfigStore = defineStore('config', () => {
  ...
  const appConfig = ref({
    ...
    episode_refresher_config: {
      ...
      enable_emby_screenshot: false,
      screenshot_time_percent: 10,
    }
    // --- 结束修改 ---
  })
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (!fullConfig.episode_refresher_config) {
          ...
          if (typeof fullConfig.episode_refresher_config.enable_emby_screenshot === 'undefined') {
            fullConfig.episode_refresher_config.enable_emby_screenshot = false;
          }
          if (typeof fullConfig.episode_refresher_config.screenshot_time_percent === 'undefined') {
            fullConfig.episode_refresher_config.screenshot_time_percent = 10;
          }
        }
        // --- 结束修改 ---
